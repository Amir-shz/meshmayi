...
function CommunicationWays() {
  return (
    <div className=" max-lg:col-span-full p-6 pb-5 max-sm:p-4 rounded-lg border border-neutral-300 bg-neutral-100 flex flex-col gap-5 max-sm:gap-4 ">
      ...
      <div className="  p-4 max-sm:p-2 rounded-lg border border-neutral-300 flex items-center justify-between flex-wrap max-sm:flex-col-reverse max-sm:items-end max-sm:flex-nowrap  ">
        <div className=" flex items-center gap-1 py-3 px-6 max-sm:px-4 max-sm:pl-1 max-xs:gap-0 max-sm:py-2 max-sm:w-full max-sm:justify-end  hover:bg-primary-50 duration-300 hover:border-primary-200 border border-neutral-100 rounded-lg max-sm:hover:bg-transparent max-sm:hover:border-transparent ">
        ...
        <div className="  max-xs:overflow-hidden flex items-center gap-1 py-3 px-6 max-sm:px-4 max-sm:pl-1 max-xs:gap-0 max-sm:py-2 max-sm:w-full  max-sm:justify-end hover:bg-primary-50 duration-300 hover:border-primary-200 border border-neutral-100 rounded-lg max-sm:hover:bg-transparent max-sm:hover:border-transparent ">
          <p className=" text-h5_B_desktop max-sm:text-h5_SB_mobile text-neutral-500 max-xs:text-[1.125rem]">
            {EMAIL}
          </p>
